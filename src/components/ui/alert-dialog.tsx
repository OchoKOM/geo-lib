...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn("text-lg font-bold text-slate-800 dark:text-slate-100", className)}
      {...props}
    />
  )
}
...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      ...
      className={cn("bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg shadow-md font-medium transition-all text-sm", className)}
      {...props}
    />
  )
}
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      ...
      className={cn("px-4 py-2 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg font-medium text-sm border-none ring-0 focus:ring-0", className)}
      {...props}
    />
  )
}
