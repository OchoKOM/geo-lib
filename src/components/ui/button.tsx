...
const buttonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        // STYLE PRIMAIRE (BLUE-600) - Similaire au bouton "Rechercher" et "Appliquer les filtres"
        default: 
          "bg-blue-600 text-white shadow-md hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700",
        
        // BOUTON DE DESTRUCTION (ROUGE) - Garde le style standard pour l'action destructive
        destructive:
        ...
        // BOUTON SECONDAIRE / OUTLINE (GRIS CLAIR) - Similaire au style du bouton "Annuler"
        outline:
        ...
        // VARIANTE SECONDAIRE - Reste similaire à `outline` mais sans bordure, comme votre bouton "Annuler"
        secondary:
